...
| **Pods RunPod dedicados (compute) ×2** | **DISPONÍVEL E TESTADA** (2026-07-11/12, configurados por Luiz) | 2× AMD EPYC 16 cores / 124GB RAM / 100GB disco / Ubuntu 20.04 · ~$0,64/h cada · pod1 SSH root@157.157.221.30:38250, pod2 :17109 (2º pod adicionado 2026-07-12 p/ acelerar o piloto — rebalanceamento 187/186/70) · Pods são PREEMPTÍVEIS (2 recreates em 2026-07-11, volume NÃO sobrevive; monitor sincroniza outputs dos DOIS a cada 15min) · Stack: kissat (source), drat-trim, Python 3.8 · tools em /workspace/tools · **desligar os dois quando o piloto acabar** |
